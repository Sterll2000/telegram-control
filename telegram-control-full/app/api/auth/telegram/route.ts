...
import { persistUserToDatabase } from '@/lib/admin-sync-db';
...
export async function POST(req: Request) {
  ...
  try {
    ...
    try{await persistUserToDatabase(user);}catch(error){console.error('Supabase user persistence failed:',error)}
